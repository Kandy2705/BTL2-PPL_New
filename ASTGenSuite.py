...
"""
    ...
    def test_151(self):
        ...
        expect = str(Program([ConstDecl("TrieuMan",None,ArrayLiteral([IntLiteral(2),IntLiteral(4),Id("a"),Id("BDH")],Id("TrieuMan"),[IntLiteral(291),NilLiteral(),BooleanLiteral("true"),IntLiteral(3438593),FloatLiteral(3.44)]))
		]))
